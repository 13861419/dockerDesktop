...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    q: '界面支持哪些语言？如何切换？',
    a: '「设置 → 关于 → 界面语言」可在中文 / English 间一键切换，偏好即时生效并记住（存于浏览器本地）。当前版本已覆盖导航、登录、公共组件与总览 / 容器 / 容器详情 / 通知中心 / 数据库 / 计划任务 / 应用商店 / Compose / 数据卷 / 审批中心 / 设置等页面，其余页面暂以中文显示，后续版本持续补齐。',
  },
];
...
const FEATURE_INDEX: Array<{ path: string; name: string; desc: string }> = [
  ...
  { path: '/approvals', name: '审批中心', desc: '高危操作审批与记录（含编排停止/批量删镜像/清理类）、近 30 天审批统计' },
