...
const FEATURE_INDEX: Array<{ path: string; name: string; desc: string }> = [
  ...
  { path: '/notifications', name: t('告警中心'), desc: t('告警规则（含连续周期防抖）、七类通知渠道、多渠道路由、送达率统计、磁盘写满与内存耗尽趋势预测、静默期值班渠道、容器自愈（标签匹配/触发上限/监控范围，执行记录筛选与导出，1.42.0）、未保存渠道直接测试连接（1.43.0）、记录与 AI 诊断') },
