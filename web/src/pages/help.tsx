...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    q: t('容器日志太多，如何快速定位报错？'),
    a: t('容器日志弹窗与 Compose 日志弹窗（1.92.0）均提供「全部 / 错误 / 警告」级别筛选 chips（附命中计数），一键只看报错行；可叠加关键字搜索高亮与时间范围过滤。Compose 日志的「跟随刷新」为 SSE 实时流，日志产生即推送，开启后自动滚底，滚轮向上滚动即退出跟随。'),
  },
  {
    q: t('首装向导会再次出现吗？'),
...
const FEATURE_INDEX: Array<{ path: string; name: string; desc: string }> = [
  ...
  { path: '/containers', name: t('容器'), desc: t('生命周期管理、终端、日志、标签过滤、批量操作、镜像自动更新与回滚、Inspect 查看、容器内进程与操作记录、配置快照对比（1.50.0）；日志弹窗（1.91.0）：时间范围过滤、时间戳、跟随刷新、条数（100/200/500/1000/全部）、清空、搜索高亮、下载；级别筛选 chips（1.92.0）：全部 / 错误 / 警告一键聚焦问题行') },
