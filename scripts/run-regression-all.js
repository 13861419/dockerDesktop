...
const SCRIPTS = [
  ...
  'regression-sites.js',
  'regression-settings.js',
  'regression-storage.js',
  'regression-backups.js',
  'regression-cloudbackup.js',
  'regression-engines.js',
  'regression-firewall.js',
  'regression-tasks.js',
  'regression-operationlogs.js',
  'regression-build.js',
  'regression-hostfiles.js',
