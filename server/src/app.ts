...
import registryCacheRouter from './routes/registryCache';
...
app.use('/api', requireAuth, openapiRouter);
...
app.use('/api/bench', requireAuth, benchRouter);
app.use('/api/registry-cache', requireAuth, registryCacheRouter);
