...
- **系统设置**：主题、界面语言（中文 / English，i18n 骨架 + 核心层英文包，未翻译页面自动回退中文）等偏好设置；告警静默 / 快捷引导等
...
生成 `DockerManager-setup-0.6.0.exe` 安装包，在目标 Windows 电脑上运行即完成安装。
