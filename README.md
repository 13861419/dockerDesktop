...
- **系统设置**：主题、界面语言（中文 / English，i18n 骨架 + 两批英文包覆盖核心层与高频页，未翻译页面自动回退中文）等偏好设置；告警静默 / 快捷引导等
...
生成 `DockerManager-setup-0.7.0.exe` 安装包，在目标 Windows 电脑上运行即完成安装。
